#!/bin/bash
restartprogram() {
echo "\e[1;31m Esa Opción es incorrecta, elije de nuevo ! \e[0m"
sleep 2
clear
menuoption
}
...
myipagain() {
	...
	if [ $ybe = "Y" ]
		...
		then
			echo " Gracias por utilizar la herramienta OVNI"
			exit
	else
		exit
	fi
...
tarjetaip() {
	...
	echo -e "\e[1;32m╭─root@MHK-4-/-OVNI \e[0m"
	read -p "╰─$ " target
...
doxing() {
    ...
    echo -e "\e[1;31m         ▐██████████████████▌  \e[0m"
    echo -e "\e[1;31m         ████████▀▀▀▀████████  \e[0m"
    echo -e "\e[1;31m        ▐█████▀\e[0m""\e[33m  ▄██▄\e[0m""\e[1;31m  ▀█████▌  \e[0m"
    echo -e "\e[1;31m        █████  \e[0m""\e[33m ▐████▌\e[0m""\e[1;31m   █████  \e[0m"
    echo -e "\e[1;31m       ▐██████▄\e[0m""\e[33m  ▀██▀ \e[0m""\e[1;31m ▄██████▌  \e[0m"
    echo -e "\e[1;31m       ██████████▄▄▄▄██████████  \e[0m"
    echo -e "\e[1;31m      ▐███████ ▐██████▌ ███████▌  \e[0m"
    echo -e "\e[1;31m      ███████▌  ▐████▌  ▐███████ \e[0m"
    echo -e ""
	echo -e "\e[1;32m Entra al siguiente Link : \e[0m"
	echo -e "\e[1;34m         _-_-_-_-_-_-_-_-_-_-_-_-__-_-_-_-_-_  \e[0m"
	echo -e "\e[1;34m        |                                   |  \e[0m"
	echo -e "\e[1;34m        |\e[0m""\e[36m    https://osintframework.com/ \e[0m""\e[1;34m   |  \e[0m"
	echo -e "\e[1;34m         -_-_-_-_-_-_-_-_-_-_-_-_-__-_-_-_-_-   \e[0m"
	echo -e ""
...
menuoption() {
	...
	echo -e "\e[1;34m[3]\e[0m" "\e[36mHerramienta de Doxing\e[0m"
	echo -e "\e[1;34m[4]\e[0m" "\e[1;31mSalir de OVNI\e[0m"
    echo -e ""
	read -p "_>$ " get
	if [ $get -eq 1 ];
		then
